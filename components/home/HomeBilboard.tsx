...
export const HomeBilboard = () => {
  return (
    <MaxWidthWrapper className="my-8 w-full h-[50vh] bg-gradient-to-br from-[#0F2027] via-[#203A43] to-[#2C5364] py-2.5 rounded-lg flex md:gap-6 text-gray-100">
      ...
      <EmblaCarousel className="hidden lg:block h-[90%] w-full my-auto">
        ...
        <div className="embla__slide flex items-center justify-center rounded-lg bg-gradient-to-br from-[#541c21] to-[#911007]">
          <h1 className="font-extrabold text-5xl">
